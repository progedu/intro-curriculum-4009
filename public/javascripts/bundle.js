...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  var disconnectButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#disconnect');
  ...
  var numberOfCurrentUser = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#numberOfCurrentUser');
  var chat_area = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#chat_area');
  ...
  socket.on('numberOfCurrentUser', function (num) {
    //接続ユーザー数
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#chat_form').submit(function () {
    socket.emit('chat_post', jquery__WEBPACK_IMPORTED_MODULE_0___default()('#message').val());
